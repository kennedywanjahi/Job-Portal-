          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              ...
              <ul class="main-nav nav navbar-nav navbar-right">
                ...
                <li class="wow fadeInDown" data-wow-delay="0.3s"><a href="about.php">About us</a></li>
                <li class="wow fadeInDown" data-wow-delay="0.5s"><a href="contactus.php">Contact</a></li>
              </ul>
            </div><!-- /.navbar-collapse -->
          </div><!-- /.container-fluid -->
        </nav>
